...
class LessonRepository {
    ...
    private val lesson2Theory = listOf(
        ...
        TheoryBlock(
            title = "Вопрос",
            text =
                "Вопрос образуется с помощью \"ли\".\n\n" +
                        "Ти си тук ли?\n" +
                        "Той е лекар ли?\n" +
                        "Вие сте вкъщи ли?"
        ),
    ...
    private val lessons = listOf(
        ...
        Lesson(
            ...
            phrases = listOf(
                ...
                Phrase("Той е добър", "Он хороший"),
                Phrase("Ние не сме вкъщи", "Мы не дома"),
                Phrase("Вие сте тук ли?", "Вы здесь?")
            ),
            questions = listOf(
                Question(
                    id = 1,
                ...
                Question(
                    id = 2,
                    text = "Как переводится «Той не е тук»?",
                    options = listOf("Он не здесь", "Он здесь", "Он не врач"),
                    correctAnswer = "Он не здесь"
                )
            )
        ),
        Lesson(
